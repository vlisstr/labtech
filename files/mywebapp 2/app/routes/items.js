// Business logic for variant V3 = 3 (Simple Inventory).
//
// Endpoints:
//   GET  /items       — list (id, name)
//   POST /items       — create  (fields: name, quantity)
//   GET  /items/:id   — full details (id, name, quantity, created_at)
//
// Each endpoint negotiates between application/json and text/html via the
// Accept header. For text/html lists we render an HTML table per the spec.
